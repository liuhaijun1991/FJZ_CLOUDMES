...
{
    public partial class HWTDownloadDn_UI : UserControl
    {
        HWTDownloadDn obj_down_dn = null;
        public HWTDownloadDn_UI(HWTDownloadDn obj_down)
        {
            InitializeComponent();
        ...
        private void DownDN_UI_Load(object sender, EventArgs e)
        {
            ...
            label1.Text += "RFC:ZRFC_SFC_NSG_0003";
        }

        private void button1_Click(object sender, EventArgs e)
        {
            obj_down_dn.DnBase_HWT.DnCreatDateTime = dateTimePicker1.Value.ToString("yyyy-MM-dd");
            obj_down_dn.Start();
            obj_down_dn.DnBase_HWT.DnCreatDateTime = "";
        }
    }
}

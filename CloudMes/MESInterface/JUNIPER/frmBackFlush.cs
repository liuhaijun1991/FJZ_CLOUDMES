...
namespace MESInterface.JUNIPER
{
    ...
    public partial class frmBackFlush :UserControl
    {
        ...
        public frmBackFlush(FJZBackflush BackFlushs)
        {
            InitializeComponent();
        ...
        private void frmBackFlush_Load(object sender, EventArgs e)
        {
            ...
            BackFlush.processRateDelegate = new FJZBackflush.ProcessRateDelegate(ProcessRate);
            BackFlush.addDataGridDelegate = new FJZBackflush.AddDataGridDelegate(AddDataGrid);
            BackFlush.setCtrlEnableDelegate = new FJZBackflush.SetCtrlEnableDelegate(SetCtrlEnable);

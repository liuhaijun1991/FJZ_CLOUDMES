...
{
    public class RMABonepileMonthlySummaryReport : ReportBase
    {
        ...
        public RMABonepileMonthlySummaryReport()
        {
        ...
        public override void Run()
        {
            ...
            try
            {
                if (int.Parse(fromYear) > int.Parse(toYear))
                {
                    ...
                    throw new MESReturnMessage(MESReturnMessage.GetMESReturnMessage("MSGCODE20210816165936")); 
                }
                if (int.Parse(fromYear) == int.Parse(toYear))
                {
                    if (int.Parse(fromMonth) > int.Parse(toMonth))
                    {
                        ...
                        throw new MESReturnMessage(MESReturnMessage.GetMESReturnMessage("MSGCODE20210816170036")); 
                    }
                }

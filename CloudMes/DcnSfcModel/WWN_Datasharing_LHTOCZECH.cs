...
namespace DcnSfcModel
{
    ...
    /// </summary>
    [Serializable]
    public class WWN_Datasharing_LHTOCZECH
    {
        public WWN_Datasharing_LHTOCZECH()
        {
			
        }
 
       #region  WWN_Datasharing_LHTOCZECH实体
	   ...
	   /// 
	   /// </summary>
	   public int MAC_block_size {get; set;}
	
	
	   /// <summary>
	   /// 
	   /// </summary>
	   public int WWN_block_size {get; set;}

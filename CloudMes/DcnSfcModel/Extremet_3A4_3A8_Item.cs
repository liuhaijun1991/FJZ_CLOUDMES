...
namespace DcnSfcModel
{
    ...
    /// </summary>
    [Serializable]
    public class Extremet_3A4_3A8_Item
    {
        public Extremet_3A4_3A8_Item()
        {
			
        }
 
       #region  Extremet_3A4_3A8_Item实体
	   ...
	   /// 
	   /// </summary>
	   public string AffirmationIndicator {get; set;}
	   ...
	   /// 
	   /// </summary>
	   public string SAP_DN {get; set;}
	
	
	   /// <summary>
	   /// 
	   /// </summary>
	   public DateTime TO_SAP_DATE {get; set;}

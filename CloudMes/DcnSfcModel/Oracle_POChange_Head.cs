...
namespace DcnSfcModel
{
    ...
    /// </summary>
    [Serializable]
    public class Oracle_POChange_Head
    {
        public Oracle_POChange_Head()
        {
			
        }
 
       #region  Oracle_POChange_Head实体
	   ...
	   /// 
	   /// </summary>
	   public string PoChangeTime {get; set;}
	
	
	   /// <summary>
	   /// 
	   /// </summary>
	   public string PoChangeTimeZone {get; set;}

...
$(document).ready(function () {
    ...
    var ShowDataJuniper = {
        ...
        yes: function (index) {
            parent.client.CallFunction("MESStation.KeyPart.KPScan", "UpLoadKPListJuniper", { SkuNo: Skuno, ListName: ListName, ListData: DataList, CustVersion: CustVersion }, function (e) {
                if (e.Status == "Pass") {
                    layer.close(index);
                    layer.msg("Success", {
                        icon: 1,
    ...
    var ToMpnFunction = function (value, row, index) {
        var Listname = row.LISTNAME;
        return [
            '<a href="../KeyPart/KeypartRuleSet.html?Listname=' + Listname+'">' + value + '</a>'
        ].join('');
    };
    ...
    $('#KP_List_Table').bootstrapTable({
        ...
        columns: [{
            ...
            field: 'LISTNAME',
            title: 'List Name',
            formatter: ToMpnFunction //表格中增加按钮
        }, {
            field: 'SKUNO',
            title: 'SkuNo'
        }, {

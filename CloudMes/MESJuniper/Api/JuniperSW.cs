...
{
    public class JuniperSW: MesAPIBase
    {
        ...
        protected APIInfo FAdd = new APIInfo
        {
            ...
            Parameters = new List<APIInputInfo>()
            {
                new APIInputInfo(){ InputName="R_JUNIPER_SW", InputType="string" }
            },
            Permissions = new List<MESPermission>()
        };
        ...
        public void GetList(JObject requestValue, JObject Data, MESStationReturn StationReturn)
        {
            ...
            try
            {
                ...
                var res = SFCDB.ORM.Queryable<R_JUNIPER_SW>()
                    .ToList();
        ...
        public void Add(JObject requestValue, JObject Data, MESStationReturn StationReturn)
        {
            ...
            try
            {
                var model = Data["R_JUNIPER_SW"].ToObject<R_JUNIPER_SW>();
                var res = SFCDB.ORM.Ado.UseTran(() =>
                {
                    model.ID = MesDbBase.GetNewID<R_JUNIPER_SW>(SFCDB.ORM, this.BU);
        ...
        public void Delete(JObject requestValue, JObject Data, MESStationReturn StationReturn)
        {
            ...
            try
            {
                ...
                var datalist = SFCDB.ORM.Queryable<R_JUNIPER_SW>().Where(t => ids.Contains(t.ID)).ToList();
                var res = SFCDB.ORM.Ado.UseTran(() =>
                {

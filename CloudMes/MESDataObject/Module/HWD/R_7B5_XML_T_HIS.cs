...
{
    public class T_R_7B5_XML_T_HIS : DataObjectTable
    {
        public T_R_7B5_XML_T_HIS(string _TableName, OleExec DB, DB_TYPE_ENUM DBType) : base(_TableName, DB, DBType)
        {

        }
        public T_R_7B5_XML_T_HIS(OleExec DB, DB_TYPE_ENUM DBType)
        {
            RowType = typeof(Row_R_7B5_XML_T_HIS);
            TableName = "R_7B5_XML_T_HIS".ToUpper();
            DataInfo = GetDataObjectInfo(TableName, DB, DBType);
        }
    }
    public class Row_R_7B5_XML_T_HIS : DataObjectBase
    {
        public Row_R_7B5_XML_T_HIS(DataObjectInfo info) : base(info)
        {

        }
        public R_7B5_XML_T_HIS GetDataObject()
        {
            R_7B5_XML_T_HIS DataObject = new R_7B5_XML_T_HIS();

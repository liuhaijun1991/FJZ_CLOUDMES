...
{
    public class T_R_CUSTSN_DETAIL_T : DataObjectTable
    {
        public T_R_CUSTSN_DETAIL_T(string _TableName, OleExec DB, DB_TYPE_ENUM DBType) : base(_TableName, DB, DBType)
        {

        }
        public T_R_CUSTSN_DETAIL_T(OleExec DB, DB_TYPE_ENUM DBType)
        {
            RowType = typeof(Row_R_CUSTSN_DETAIL_T);
            TableName = "R_CUSTSN_DETAIL_T".ToUpper();
            DataInfo = GetDataObjectInfo(TableName, DB, DBType);
        }

        public R_CUSTSN_DETAIL_T GetTestDataBySn(string SN, OleExec DB, DB_TYPE_ENUM DBType)
        {
            return DB.ORM.Queryable<R_CUSTSN_DETAIL_T>().Where(t => t.SERIAL_NUMBER == SN).ToList().FirstOrDefault();
        }
    }
    public class Row_R_CUSTSN_DETAIL_T : DataObjectBase
    {
        public Row_R_CUSTSN_DETAIL_T(DataObjectInfo info) : base(info)
        {

        }
        public R_CUSTSN_DETAIL_T GetDataObject()
        {
            R_CUSTSN_DETAIL_T DataObject = new R_CUSTSN_DETAIL_T();
    ...
    public class R_CUSTSN_DETAIL_T
    {

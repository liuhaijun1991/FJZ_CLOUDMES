...
{
    public class T_R_I139_TEMP : DataObjectTable
    {
        public T_R_I139_TEMP(string _TableName, OleExec DB, DB_TYPE_ENUM DBType) : base(_TableName, DB, DBType)
        {

        }
        public T_R_I139_TEMP(OleExec DB, DB_TYPE_ENUM DBType)
        {
            RowType = typeof(Row_R_I139_TEMP);
            TableName = "R_I139_TEMP".ToUpper();
            DataInfo = GetDataObjectInfo(TableName, DB, DBType);
        }
    }
    public class Row_R_I139_TEMP : DataObjectBase
    {
        public Row_R_I139_TEMP(DataObjectInfo info) : base(info)
        {

        }
        public R_I139_TEMP GetDataObject()
        {
            R_I139_TEMP DataObject = new R_I139_TEMP();

...
{
    public class T_R_I244 : DataObjectTable
    {
        public T_R_I244(string _TableName, OleExec DB, DB_TYPE_ENUM DBType) : base(_TableName, DB, DBType)
        {

        }
        public T_R_I244(OleExec DB, DB_TYPE_ENUM DBType)
        {
            RowType = typeof(Row_R_I244);
            TableName = "R_I244".ToUpper();
            DataInfo = GetDataObjectInfo(TableName, DB, DBType);
        }
    }
    public class Row_R_I244 : DataObjectBase
    {
        public Row_R_I244(DataObjectInfo info) : base(info)
        {

        }
        public R_I244 GetDataObject()
        {
            R_I244 DataObject = new R_I244();
    ...
    [SqlSugar.SugarTable("jnp.TB_I244")]
    public class B2B_R_I244
    {
        public string F_ID { get; set; }
        public string F_PLANT { get; set; }
        public string FILENAME { get; set; }

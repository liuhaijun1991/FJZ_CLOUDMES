...
{
    public class T_R_I285_SOURCE : DataObjectTable
    {
        public T_R_I285_SOURCE(string _TableName, OleExec DB, DB_TYPE_ENUM DBType) : base(_TableName, DB, DBType)
        {

        }
        public T_R_I285_SOURCE(OleExec DB, DB_TYPE_ENUM DBType)
        {
            RowType = typeof(Row_R_I285_SOURCE);
            TableName = "R_I285_SOURCE".ToUpper();
            DataInfo = GetDataObjectInfo(TableName, DB, DBType);
        }
    }
    public class Row_R_I285_SOURCE : DataObjectBase
    {
        public Row_R_I285_SOURCE(DataObjectInfo info) : base(info)
        {

        }
        public R_I285_SOURCE GetDataObject()
        {
            R_I285_SOURCE DataObject = new R_I285_SOURCE();
